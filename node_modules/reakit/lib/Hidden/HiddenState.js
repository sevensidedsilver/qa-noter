...
function useHiddenState(initialState) {
  ...
  var show = React.useCallback(function () {
    process.env.NODE_ENV !== "production" ? warning.warning(!isMounted, "[reakit/Hidden]", "You're trying to show a hidden element that hasn't been mounted yet.", "You shouldn't conditionally render a `Hidden` component (or any of its derivatives) as this will make some features not work.", "If this is intentional, you can omit this warning by passing `unstable_isMounted: true` to `useHiddenState` or just ignore it.", "See https://reakit.io/docs/hidden/#conditionally-rendering") : void 0;
    setVisible(true);
  }, [isMounted]);
  ...
  var toggle = React.useCallback(function () {
    process.env.NODE_ENV !== "production" ? warning.warning(!isMounted, "[reakit/Hidden]", "You're trying to toggle a hidden element that hasn't been mounted yet.", "You shouldn't conditionally render a `Hidden` component (or any of its derivatives) as this will make some features not work.", "If this is intentional, you can omit this warning by passing `unstable_isMounted: true` to `useHiddenState` or just ignore it.", "See https://reakit.io/docs/hidden/#conditionally-rendering") : void 0;
